...
- Statistical behavior gets parity tests against Abacus fixtures.
...
- Numerical parity with Abacus is more important than aesthetic refactors.
...
4. Does it preserve or improve parity with Abacus?
