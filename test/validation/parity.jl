...
const _VALIDATION_FIXTURE_ROOT = joinpath(@__DIR__, "..", "fixtures", "abacus", "validation")
...
@testset "Phase 11 Abacus parity rows match compact validation fixtures" begin
    cases = [
...
@testset "Phase 12 holiday-bearing native reference row remains truthful" begin
...
@testset "Phase 11 bounded panel contract row remains truthful" begin
